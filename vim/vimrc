...
set ignorecase
" don't ignore case when pattern has uppercase
set smartcase
" match while typing search pattern
set incsearch
" don't keep highlights around after search
set nohlsearch
" search down into subfolders when finding files
set path+=**
" ignore autogenerated files/folders
set wildignore+=\*.git/\*
" display all matching files when we tab complete
set wildmenu
" better completion behavior for file searching
...
set showmode
" do not display the sign column
set signcolumn=no
...
" ' bp' to move to the previous buffer
nnoremap <leader>bp :bprevious<Enter>
" ' ff' to fuzzy find files
